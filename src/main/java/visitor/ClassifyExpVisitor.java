...
//    selectCond.get(tableName).add(expr);
    ...
    String aliasOrName = column.getTable().getAlias() != null
...
//    }
    ...
    String leftAliasOrName = leftCol.getTable().getAlias() != null
            ? leftCol.getTable().getAlias().getName()
            : leftCol.getTable().getName();

    String rightAliasOrName = rightCol.getTable().getAlias() != null
